...
<div class='c'>
    ...
    <hr>
    <div class='_1'>GET BACK TO READING AND PREPARING FOR FINALS!!!</div>
    <br>
    <div class='_2' style="color: red;">No  ${pageName} for now.</div>
</div>
 `;
};
...
let websiteLink = window.location.hostname
